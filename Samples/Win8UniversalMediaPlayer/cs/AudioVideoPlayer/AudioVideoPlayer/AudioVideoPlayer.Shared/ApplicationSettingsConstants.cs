...
namespace AudioVideoPlayer
{
    ...
    {
        // Data keys
        public const string DiscoveredAudioFiles = "discoveredaudiofiles";
        public const string DiscoveredAlbums = "discoveredaudiofiles";
        public const string DiscoveredArtists = "discoveredartists";
        public const string DiscoveredCurrentFolder = "discoveredcurrentfolder";
